...
describe('Service Tests', () => {
    ...
    describe('CommunityMeetingFaces Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(CommunityMeetingFacesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/communities/' + 123);
            });
            it('should return CommunityMeetingFaces', () => {

                let entity: CommunityMeetingFaces;
                service.find(123).subscribe((_entity: CommunityMeetingFaces) => {
                    entity = _entity;
                });
