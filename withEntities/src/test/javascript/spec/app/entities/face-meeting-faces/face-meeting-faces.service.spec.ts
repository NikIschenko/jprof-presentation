...
describe('Service Tests', () => {
    ...
    describe('FaceMeetingFaces Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(FaceMeetingFacesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/faces/' + 123);
            });
            it('should return FaceMeetingFaces', () => {

                let entity: FaceMeetingFaces;
                service.find(123).subscribe((_entity: FaceMeetingFaces) => {
                    entity = _entity;
                });
