...
describe('Service Tests', () => {
    ...
    describe('ImageMeetingFaces Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ImageMeetingFacesService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ImageMeetingFaces', () => {

                let entity: ImageMeetingFaces;
                service.find(123).subscribe((_entity: ImageMeetingFaces) => {
                    entity = _entity;
                });
