...
describe('Service Tests', () => {
    ...
    describe('MeetupMeetingFaces Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(MeetupMeetingFacesService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/meetups/' + 123);
            });
            it('should return MeetupMeetingFaces', () => {

                let entity: MeetupMeetingFaces;
                service.find(123).subscribe((_entity: MeetupMeetingFaces) => {
                    entity = _entity;
                });
