...
@Injectable()
export class SpeakerMeetingFacesPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.speakerModalRef(component, new SpeakerMeetingFaces());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    speakerModalRef(component: Component, speaker: SpeakerMeetingFaces): NgbModalRef {
