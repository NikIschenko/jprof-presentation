...
@Injectable()
export class FaceMeetingFacesPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.faceModalRef(component, new FaceMeetingFaces());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    faceModalRef(component: Component, face: FaceMeetingFaces): NgbModalRef {
