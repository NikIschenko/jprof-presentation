...
public class FaceResource {
    ...
    @PostMapping("/faces")
    @Timed
    public ResponseEntity<FaceDTO> createFace(@Valid @RequestBody FaceDTO faceDTO) throws URISyntaxException {
    ...
    @PutMapping("/faces")
    @Timed
    public ResponseEntity<FaceDTO> updateFace(@Valid @RequestBody FaceDTO faceDTO) throws URISyntaxException {
